<?php /* Smarty version 2.6.26, created on 2022-09-25 08:00:17
         compiled from adminnotificationview.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ADMIN/charts/chartjs.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ChartJS</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="ADMIN/tables/jsgrid.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>jsGrid</p>
                </a>
              </li>
...
?> 
                  ...
                  <tr>
                    ...
                    <td><a href="notificationprofile.php?key=<?php echo $this->_tpl_vars['d']['nkey']; ?>
" class="btn btn-primary">Edit</a></td>
                    <td><a href="notificationdelete.php?key=<?php echo $this->_tpl_vars['d']['nkey']; ?>
