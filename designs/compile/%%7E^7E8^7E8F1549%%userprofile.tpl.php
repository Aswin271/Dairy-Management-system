<?php /* Smarty version 2.6.26, created on 2022-09-25 08:36:53
...
<body>
	<h2 align="center">PROFILE UPDATION</h2>
	<table align="center">
	<form method="post">
...
<!-- 		<tr>
			<td>Password</td>
			<td><input type="password" name="password" class="form-control" value="<?php echo $this->_tpl_vars['d']['name']; ?>
"></td>
		</tr>
 -->		<tr>
